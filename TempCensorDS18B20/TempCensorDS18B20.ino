...
void loop() {
    ...
    if (_oneSecondTimeOut.IsTimeOut()) {
        ...
        float celsius = _tempDS18B20Sensor.getTempCByIndex(0);
        float fahrenheit = _tempManager.CelsiusToFahrenheit(celsius);
        _tempManager.Add(celsius);
        Board.TraceFormat("Temp %sC, %sF", celsius, fahrenheit);
